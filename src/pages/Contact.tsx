          ...
          <div className="space-y-6">
            ...
            <div className={`${glassCardClass} p-6`}>
              <h3 className="font-semibold text-cool-slate-900 dark:text-white mb-4 flex items-center">
                <MessageSquare className="h-5 w-5 mr-2 text-green-600 dark:text-green-400" />
                Stay Connected
              </h3>
              <p className="text-cool-slate-600 dark:text-cool-slate-300 mb-4">
                Join our WhatsApp group to get the latest updates, insights, and exclusive content about AI innovations.
              </p>
              <ActionButton 
                href="https://chat.whatsapp.com/your-group-link" 
                variant="primary" 
                className="w-full group bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700"
              >
                <div className="flex items-center justify-center">
